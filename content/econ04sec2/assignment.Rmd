...
data.frame(Group = c('Group 1', 'Group 2', 'Group 3', 'Group 4', 'Group 5'),
           Topics = c('Impact of health on economic growth', 'Trade between India and European Union', 'Impact of FII on Indian stock market', 'Impact of infrasatructure on Indian tourism sector', 'Decentralisation and development in India')) %>% 
  flextable::flextable()
```
